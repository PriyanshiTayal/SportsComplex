...
class Sport(models.Model):
    ...
    img_url = models.CharField(max_length=2083, verbose_name = 'Image', default = 'https://uploads-ssl.webflow.com/617b224ba2374548fcc039ba/617b224ba237453ce1c0409b_hpfulq-1234-1024x512.jpg')
    def __str__(self):
        return f'{self.name}'
